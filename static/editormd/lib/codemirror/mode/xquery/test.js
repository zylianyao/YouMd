...
(function() {
  ...
  MT("eviltest",
     ...
     "      [keyword declare] [keyword private] [keyword function] [def&variable locale:declare]() {()}[variable ;]",
     "      [keyword declare] [keyword private] [keyword function] [def&variable locale:private]() {()}[variable ;]",
     "      [keyword declare] [keyword private] [keyword function] [def&variable locale:function]() {()}[variable ;]",
     "      [keyword declare] [keyword private] [keyword function] [def&variable locale:locale]() {()}[variable ;]",
